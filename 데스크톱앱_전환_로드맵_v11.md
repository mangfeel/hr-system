...
- **현재 진행 상태**: ✅ **전체 완료** 🎉
- **최신 앱 버전**: v1.0.14 (GitHub Release)
...
| 파일 | 경로 | 버전 | 변경 내용 |
|------|------|------|----------|
| 초기화_인사.js | C:\hr-system\js\ | v3.2.0 | async/await 적용 |
| 백업_인사.js | C:\hr-system\js\system\ | v4.1 | 보안 백업 형식 |
| 복원가져오기_인사.js | C:\hr-system\js\system\ | v4.2 | 호봉 숫자 변환 버그 수정 |
| 경력편집_인사.js | C:\hr-system\js\career\ | v4.1.1 | 캐시 무효화 및 비동기 처리 |
| login.html | C:\hr-system\ | v1.1.1 | 로그인 정보 자동 입력 |
| index.html | C:\sw-hrm-landing\ | - | 양식 다운로드 섹션 추가, 직접 등록 권장 안내 |
| 초기_데이터_가져오기_양식.xlsx | C:\sw-hrm-landing\ | NEW | 직원 일괄 등록 양식 |
| 포상_데이터_가져오기_양식.xlsx | C:\sw-hrm-landing\ | NEW | 포상 일괄 등록 양식 |
